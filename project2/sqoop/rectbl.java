// ORM class for table 'rectbl'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jun 25 12:39:41 IST 2022
...
public class rectbl extends SqoopRecord  implements DBWritable, Writable {
  ...
  public rectbl with_custid(Integer custid) {
    this.custid = custid;
    return this;
  }
  ...
  public rectbl with_username(String username) {
    this.username = username;
    return this;
  }
  ...
  public rectbl with_quote_count(String quote_count) {
    this.quote_count = quote_count;
    return this;
  }
  private String ip;
  ...
  public rectbl with_ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public rectbl with_prp_1(String prp_1) {
    this.prp_1 = prp_1;
    return this;
  }
  ...
  public rectbl with_prp_2(String prp_2) {
    this.prp_2 = prp_2;
    return this;
  }
  ...
  public rectbl with_prp_3(String prp_3) {
    this.prp_3 = prp_3;
    return this;
  }
  private String ms;
  ...
  public rectbl with_ms(String ms) {
    this.ms = ms;
    return this;
  }
  ...
  public rectbl with_http_type(String http_type) {
    this.http_type = http_type;
    return this;
  }
  ...
  public rectbl with_purchase_category(String purchase_category) {
    this.purchase_category = purchase_category;
    return this;
  }
  ...
  public rectbl with_total_count(String total_count) {
    this.total_count = total_count;
    return this;
  }
  ...
  public rectbl with_purchase_sub_category(String purchase_sub_category) {
    this.purchase_sub_category = purchase_sub_category;
    return this;
  }
  ...
  public rectbl with_http_info(String http_info) {
    this.http_info = http_info;
    return this;
  }
  ...
  public rectbl with_status_code(Integer status_code) {
    this.status_code = status_code;
    return this;
  }
  ...
  public rectbl with_Date_col(java.sql.Date Date_col) {
    this.Date_col = Date_col;
    return this;
  }
  private Integer day;
  ...
  public rectbl with_day(Integer day) {
    this.day = day;
    return this;
  }
  private String Year;
  ...
  public rectbl with_Year(String Year) {
    this.Year = Year;
    return this;
  }
  ...
  public rectbl with_Month(String Month) {
    this.Month = Month;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof rectbl)) {
      return false;
    }
    rectbl that = (rectbl) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.prp_1 = JdbcWritableBridge.readString(5, __dbResults);
    this.prp_2 = JdbcWritableBridge.readString(6, __dbResults);
    this.prp_3 = JdbcWritableBridge.readString(7, __dbResults);
    this.ms = JdbcWritableBridge.readString(8, __dbResults);
    this.http_type = JdbcWritableBridge.readString(9, __dbResults);
    this.purchase_category = JdbcWritableBridge.readString(10, __dbResults);
    this.total_count = JdbcWritableBridge.readString(11, __dbResults);
    this.purchase_sub_category = JdbcWritableBridge.readString(12, __dbResults);
    this.http_info = JdbcWritableBridge.readString(13, __dbResults);
    this.status_code = JdbcWritableBridge.readInteger(14, __dbResults);
    this.Date_col = JdbcWritableBridge.readDate(15, __dbResults);
    this.day = JdbcWritableBridge.readInteger(16, __dbResults);
    this.Year = JdbcWritableBridge.readString(17, __dbResults);
    this.Month = JdbcWritableBridge.readString(18, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(prp_1, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(prp_2, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(prp_3, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(ms, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(http_type, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(purchase_category, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(total_count, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(purchase_sub_category, 12 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(http_info, 13 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(status_code, 14 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeDate(Date_col, 15 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeInteger(day, 16 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(Year, 17 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(Month, 18 + __off, 12, __dbStmt);
    return 18;
  }
...
this.readFields0(__dataIn);  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.custid = null; } else {
      this.custid = Integer.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.username = null; } else {
      this.username = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.quote_count = null; } else {
      this.quote_count = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.ip = null; } else {
      this.ip = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.prp_1 = null; } else {
      this.prp_1 = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.prp_2 = null; } else {
      this.prp_2 = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.prp_3 = null; } else {
      this.prp_3 = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.ms = null; } else {
      this.ms = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.http_type = null; } else {
      this.http_type = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.purchase_category = null; } else {
      this.purchase_category = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.total_count = null; } else {
      this.total_count = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.purchase_sub_category = null; } else {
      this.purchase_sub_category = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.http_info = null; } else {
      this.http_info = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.status_code = null; } else {
      this.status_code = Integer.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.Date_col = null; } else {
      this.Date_col = java.sql.Date.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.day = null; } else {
      this.day = Integer.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.Year = null; } else {
      this.Year = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.Month = null; } else {
  ...
  public Object clone() throws CloneNotSupportedException {
    rectbl o = (rectbl) super.clone();
    o.Date_col = (o.Date_col != null) ? (java.sql.Date) o.Date_col.clone() : null;
    return o;
  }

  public void clone0(rectbl o) throws CloneNotSupportedException {
    o.Date_col = (o.Date_col != null) ? (java.sql.Date) o.Date_col.clone() : null;
  }
